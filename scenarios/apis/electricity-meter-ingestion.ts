...
import { generateMeterPayload, generateElectricityPayload, generateGasPayload } from "../../lib/builders/index.ts";
 ...
 */
export function electricityMeterIngestionScenario(
	baseUrl: string,
	...
	const payload = generateElectricityPayload(vuId, iterId);
